...
class Transition1Scene extends Scene {
  ...
  async setupTv() {
    ...
    tv.model.position.set(0, 0, -10); // Start far away on the z-axis
    // video
  ...
  setupSpotLight(target: THREE.Object3D) {
    ...
    this.spotLight.position.set(0, 30, 0); // Position the light above the TV
...
export default Transition1Scene;